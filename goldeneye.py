...
class Laser(Process):
    ...
    def __init__(self, url, nr_sockets, counter):
        ...
        self.useragents = [
            'Mozilla/5.0 (X11; U; Linux x86_64; en-US; rv:1.9.13) Gecko/20090913 Firefox/3.5.3',
            'Mozilla/5.0 (Windows; U; Windows NT 6.1; en; rv:1.9.13) Gecko/20090824 Firefox/3.5.3 (.NET CLR 3.5.3729)',
            'Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US; rv:1.9.1.3) Gecko/20090824 Firefox/3.5.4 (.NET CLR 3.5.3729)',
            'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.1) Gecko/20090718 Firefox/3.5.4',
            'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US) AppleWebKit/53.1 (KHTML, like Gecko) Chrome/4.0.219.122 Safari/532.1',
            'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; WOW64; Trident/4.0; SLC2; .NET CLR 2.0.5727; InfoPath.2)',
            'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.0; Trident/4.0; SLCC1; .NET CLR 2.0.5727; .NET CLR 1.1.4322; .NET CLR 3.5.30729; .NET CLR 3.0.30729)',
            'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.2; Win64; x64; Trident)',
            'Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0; SV1; .NET CLR 2.0.50727; InfoPath2)',
            'Mozilla/5.0 (Windows; U; MSIE 7.0; Windows NT 6; en-US)',
            'Mozilla/4.0 (compatible; MSIE 6.1; Windows 7)',
            'Opera/9.80 (Windows NT 5.2; U; ru) Presto/2.5.22 Version/12',
            ]
